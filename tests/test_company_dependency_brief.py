...
class FakeBriefLLM:
    def chat_json(self, system: str, user: str, max_tokens: int = 1200):
        ...
        return {
            "one_paragraph_summary": "NVIDIA has named foundry, packaging, and strategic partner evidence.",
            "what_this_implies": ["Named current-fact dependencies are stronger than generic class risk language."],
            "what_to_monitor": ["Monitor whether risk language turns into named counterparties in future filings."],
            "weak_or_missing_evidence": ["Generic supplier classes are not resolved legal entities."],
        }
