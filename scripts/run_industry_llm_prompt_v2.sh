...
export VALUECHAIN_RUN_ID="${VALUECHAIN_RUN_ID:-industry-sec-exhibits-v2}"
export VALUECHAIN_RUN_LABEL="${VALUECHAIN_RUN_LABEL:-Industry SEC exhibits v2 - balanced 40 x2}"
