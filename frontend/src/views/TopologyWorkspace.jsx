...
export function TopologyWorkspace() {
  ...
  return <section className="topology-workspace">
    ...
    {data && <TopologyMap edges={data.edges || []} networkEdges={data.network_edges || []} companies={data.companies || []} evidence={data.evidence || []} lineageEvents={data.relationship_lineage_events || []} industryExpansion={data.industry_expansion || {}} />}
