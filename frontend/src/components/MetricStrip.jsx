export function MetricStrip({ data, filteredCompanies, filteredEdges, filteredEvidence, filteredBottlenecks }) {
  ...
  const canonicalRelationships = data?.summary?.canonical_relationship_count || 0;
  ...
  return (
    <section className="metrics">
      ...
      <Metric label="Canonical Supply" value={canonicalRelationships} detail="named supplier-to-customer links" />
    </section>
  );
}
